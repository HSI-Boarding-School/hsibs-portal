    ...
    case 'apparent':
      return {
        ...
        section: {
          ...
          '--nav-item-root-open-color': palette.primary.light,
          '--nav-item-root-open-bg': palette.primary.lighter,
          '--nav-item-root-active-bg': palette.primary.lighter,
          // bullet
          '--nav-bullet-light-color': bulletColor.dark,
          // sub
          ...(navLayout === 'vertical' && {
            '--nav-item-sub-active-color': palette.primary.light,
